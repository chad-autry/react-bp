    ...
    return (
      <div>
          ...
          <div className="panel-body">
            ...
            <h3 className="panel-title" onClick={() => this.policyCheckClicked(index)} >
                  Accept:
                 <i
                  className={
                this.state.policies[index].checked
        ...
        <div className="center-form panel">
          <div className="panel-body">
            ...
            <button
              className={
                this.state.policies.reduce((accumulator, currentValue) => {return accumulator && currentValue.checked;}, true)
                  ? "btn btn-lg btn-block btn-success"
                  : "btn btn-lg btn-block btn-success disabled"
              }
              onClick={() => {
                  if (this.state.policies.reduce((accumulator, currentValue) => {
                      return accumulator && currentValue.checked;}, true)) {
                      //Set spinner
                      this.props.fetchService.getJsonWithAuth('/backend/policyAccepted', 
                       'application/json', 
                       (json) => {
                           //Success
                           //remove spinner
                       ...
                       {"acceptedPolicy":this.state.policies})
                  }
              }}>
              Create User
            </button>
