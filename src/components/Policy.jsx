    ...
    return (
      <div>
          ...
          <div className="panel-body">
            ...
            <h3 className="panel-title" onClick={() => this.props.policyCheckClicked(index)} >
                  Accept:
                 <i
                  className={
    ...
    return (
        <div className="center-form panel">
          <div className="panel-body">
            ...
            <button
              className={
                this.props.policies.reduce((accumulator, currentValue) => {return accumulator && currentValue.checked;}, true)
                  ? "btn btn-lg btn-block btn-success"
                  : "btn btn-lg btn-block btn-success disabled"
              }
              onClick={() => {
                  if (this.props.policies.reduce((accumulator, currentValue) => {
